...
⭐ **For chain IDs and RPC endpoints, read [ethereum-lists/chains](https://github.com/ethereum-lists/chains)** (★9,830 · 2026-09-23) or **[Chainlist](https://chainlist.org/)**, rather than copying from a blog post. ⚠️ But note it lists dead networks as `active` — **the registry is not a liveness oracle.**
...
| Install **Truffle + Ganache** | Archived. The 2026 default is **[Foundry](https://github.com/foundry-rs/foundry)** (★10,623 · 2026-09-24) — `anvil` replaces Ganache |
